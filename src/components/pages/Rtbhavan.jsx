...
const Rtbhavan = ({ onClose }) => {
  return (
    <div>
      <div className={Naga.total}>
      <div className={Naga.wdiv}>
        <div className={Naga.header1}>
      <div className={Naga.head}><b>Ratan Tata Bhavan</b></div>
      <div className={Naga.head2} onClick={onClose}><RxCross2 /></div>
      </div>
      <div className={Naga.wdiv2}>
      <div className={Naga.photos}>
        <div className={Naga.photo1}><img src="/rtbhavan.jpg" alt="" /></div>
      <div className={Naga.photo2}><img src="/rtbhavan2.jpg" alt="" /></div></div>
